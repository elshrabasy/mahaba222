...
export function LoginPage() {
  ...
  return (
    <div className="relative flex h-full items-center justify-center overflow-hidden bg-gradient-to-br from-mapco-950 via-mapco-900 to-slate-950 p-6">
      ...
      <div className="relative grid w-full max-w-6xl grid-cols-1 gap-6 lg:grid-cols-[1fr_430px]">
        <div className="hidden rounded-[2rem] border border-white/10 bg-white/10 p-8 text-white shadow-2xl backdrop-blur lg:block">
          ...
          <p className="mt-4 max-w-xl text-lg text-white/75">نظام تجاري لإدارة الإنتاج، المخزون، الشحنات، المستندات والنسخ الاحتياطي لشركات الطباعة والقوالب.</p>
